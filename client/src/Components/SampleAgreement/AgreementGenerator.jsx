...
function AgreementGenerator() {
  ...
  const validateStep = (currentStep) => {
    switch (currentStep) {
      case 1:
        ...
        if (!formData.landlordAge || !formData.tenantAge) {
  ...
  const trustFeatures = [
    { icon: HiSparkles, text: "AI-Powered", subtext: "Generated by Gemini AI" },
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-5">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-sm">
                    ...
                    <div className="bg-white/60 rounded-lg p-3">
                      ...
                      <p className="font-semibold text-green-700">₹{Number(formData.rentAmount).toLocaleString('en-IN')}</p>
                    </div>
                    <div className="bg-white/60 rounded-lg p-3">
                      <p className="text-gray-500 text-xs mb-1">Deposit</p>
                      <p className="font-semibold text-blue-700">₹{Number(formData.securityDeposit).toLocaleString('en-IN')}</p>
                    </div>
                    <div className="bg-white/60 rounded-lg p-3">
      ...
      <div className="max-w-4xl mx-auto mt-8 text-center">
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
          <p className="text-amber-800 text-xs sm:text-sm">
            <strong>⚖️ Legal Disclaimer:</strong> This is an AI-generated draft for informational purposes only. 
